            ...
            <>
              <motion.div
                ...
                style={{
                  ...
                  background: `linear-gradient(to bottom, #f97316, #dc2626, #e11d48)`,
                  boxShadow: `0 0 15px rgba(220,38,38,0.5), 0 0 25px rgba(225,29,72,0.3)`,
                }}
              />
              <motion.div
              ...
              >
                <motion.div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, rgba(225,29,72,0.8) 0%, rgba(220,38,38,0.5) 40%, rgba(249,115,22,0) 70%)",
                    boxShadow:
                      "0 0 15px 4px rgba(225,29,72,0.6), 0 0 25px 8px rgba(220,38,38,0.4), 0 0 40px 15px rgba(249,115,22,0.2)",
                  }}
